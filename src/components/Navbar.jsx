...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-white shadow-sm py-4 px-4 w-full z-50 fixed top-12 left-0">
            ...
            <div className="flex items-center space-x-4 relative">
              <div className="relative">
                <input
                  ...
                  className="pl-4 pr-10 py-2 text-sm border rounded-md bg-gray-100 placeholder:text-gray-500"
                />
                <Search className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-500" />
              </div>
              <Link to="/wishlist">
                <Heart className="h-5 w-5 text-black cursor-pointer" />
              </Link>
              <Link to="/cart">
                <ShoppingCart className="h-5 w-5 text-black cursor-pointer" />
              </Link>
              <div className="relative">
                <User
                  className="h-5 w-5 text-black cursor-pointer"
